# ingress-adapter-neptun-masterdata <!-- omit in toc -->
...
Transforms columns names from german abbreviations to more userfriendly names

### Usage
```sh
$ python -m transform_neptun_masterdata.transform [--ingresss_time %Y-%m-%dT%H']
```
...
`/etc/transform-neptun-masterdata-conf.ini`. 
