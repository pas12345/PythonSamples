# transform-declaration-production <!-- omit in toc -->
...
### Usage
```sh
$ python -m transform_declaration_production.transform [--ingress_time %Y-%m-%dT%H']
```
...
`/etc/transform-declaration-production-conf.ini`. 
