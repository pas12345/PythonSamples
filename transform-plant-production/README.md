# ingress-adapter-plant-production <!-- omit in toc -->
...
### Usage
```sh
$ python -m transform_plant_production.transform [--ingresss_time %Y-%m-%dT%H']
```
...
`/etc/transform-plant-production-conf.ini`. 
