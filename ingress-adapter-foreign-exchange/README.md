# ingress-adapter-foreign-exchange <!-- omit in toc -->
...
Ingress adapter to ingress data from SAP/Foreign Exchange to the DataPlatform.

### Usage
```sh
$ python -m ingress_adapter_foreign_exchange.adapter
```
...
`/etc/transform-foreign-exchange-conf.ini`. 
