...
class ForeignExchangeAdapter(IngressAdapter):
    ...
    def retrieve_data(self) -> Optional[bytes]:
        ...
        select = "select=UTC_HOUR_TEXT_FULL,PRICE_AREA_CODE,READING_VALUE'"
...
def ingest_foreign_exchange_data(start_date: datetime, end_date: datetime):
    """
...
if __name__ == "__main__":
    ...
    while start_date < end_date:
        ...
        ingest_foreign_exchange_data(start_date, end_date)
