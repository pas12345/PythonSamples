# ingress-adapter-meta-plant-declaration <!-- omit in toc -->
...
### Usage
```sh
$ python -m ingress_adapter_meta_plant_declaration.adapter
```
...
`/etc/transform-meta-plant-declaration-conf.ini`. 
